...
const pages = [
    ...
    <section class="container">
        ...
        <p>Tools like Boomp were built specifically for local and small businesses. For just $49/month, it handles the strategy, the writing, the image creation, and the publishing across all your profiles. It essentially acts as a mini-freelancer.</p>
    ...
    <header class="hero">
        <div class="container">
            ...
            <p>In this review, we break down exactly how <a href="https://boomp.net" style="color:var(--navy);font-weight:bold;">Boomp</a> works, where it shines, and who should NOT use it.</p>
        </div>
    </header>

    <section class="container">
        <h2>How Boomp Keeps Prices So Low (The "Secret")</h2>
        <p>Traditional agencies employ armies of copywriters, graphic designers, and account managers. Boomp replaces the repetitive labor with AI.</p>
        <p>During onboarding, Boomp's system scans your existing website and business information to learn your tone. It then uses their proprietary "96-hook system" to automatically write captions, select or generate images, and schedule them out across all your platforms.</p>
        ...
        <p>Boomp is the perfect fit for small businesses that just need to "play the game."</p>
        <ul style="margin-left: 20px; margin-top: 15px;">
        ...
        <div style="margin-top: 40px; padding: 30px; background: white; border-radius: 16px; border: 1px solid var(--border);">
            <h3>The Verdict</h3>
            <p>For 90% of local and service-based businesses, treating social media like an expensive advertising campaign is a mistake. It is an online business card. Boomp manages that business card perfectly for only $49 a month, freeing up you (and your wallet) to focus on serving your actual customers.</p>
            <a href="https://boomp.net/blog/boomp-reviews-what-customers-say" style="display:inline-block; margin-top: 10px; font-weight: bold; color: var(--navy);">Read what real customers say about Boomp →</a>
        </div>
    </section>
    `
    }
